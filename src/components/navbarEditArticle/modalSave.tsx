...
export default function ModalSave(props: { 
    ...
    saveModalOpen: boolean, setSaveModalOpen: (open: boolean) => void, 
    ...
    return (
        <Modal open={props.saveModalOpen} className='modal modal-form' onClose={() => props.setSaveModalOpen(false)}>
            <form className='modal-content' onSubmit={handleSubmit}>
                <h2>Sauvegarder</h2>
                <div className='modal-form-input'>
                <TextField label="Nom de l'article" type='text' required autoFocus value={titleArticle} onChange={handleTitleChange} />
                </div>
                <span>Modifer le titre de l'article modifie le premier titre de niveau 1</span>
                <div className='modal-form-buttons'>
                    <Button type='submit' color='success' variant="contained">Valider</Button>
                    <Button onClick={() => props.setSaveModalOpen(false)} color='error' variant="contained">Annuler</Button>
                </div>
            </form>
        </Modal>
    )
